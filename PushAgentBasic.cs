...
public override void OnEpisodeBegin()
{
    ...
    // 에이전트를 (10, 1, 11) 위치로 설정
    //transform.position = new Vector3(10f, 1f, 11f);

    // 블록을 (10, 1, 9) 위치로 설정
    //block.transform.position = new Vector3(10f, 1f, 9f);

    // 블록 크기 설정
    block.transform.localScale = new Vector3(0.4f, 0.41f, 0.4f); // x, y, z 크기 설정
    ...
    SetResetParameters(); // 환경 매개변수 초기화
}
